...
const res = await fetch(`${API}/machines/${machineIdToDelete}`,{
method:"DELETE"
})
...
<button class="report">แจ้งเสีย</button> <button class="reset">รีเซ็ต</button> <button class="delete">ลบ</button>
